...
def test_weathernet():
    ...
    # wr.plot_averages(inputs, targets, predictions, test_lonfc, test_latfc, test_lonan, test_latan, "Pa", vmin_plt_rmse=0, vmax_plt_rmse=300, vmin_plt_bias=-60, vmax_plt_bias=60) # msl
    wr.plot_averages(inputs, targets, predictions, test_lonfc, test_latfc, test_lonan, test_latan, "°C", vmin_plt_rmse=0, vmax_plt_rmse=4, vmin_plt_bias=-3, vmax_plt_bias=3) # t2m
